...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("Shows Started from 1987 to 2018", NumShowsFrom87To18(shows));
            Print("Amount of Time to Binge Each Show", BingeTime(shows));
            Print("Year with the Highest Average IMDB Rating", HighestYearIMDBRating(shows));
        }
        ...
        **************************************************************************************************/
        ...
        {
            return shows.OrderByDescending(s => s.EndYear).Select(s => s.EndYear).FirstOrDefault();
        ...
        **************************************************************************************************/
        ...
        {
            return shows.Where(s => s.StartYear > 1979 && s.StartYear > 1990).SelectMany(s => s.Genres).Distinct().ToList();
        }
        ...
        public static List<string> NumShowsFrom87To18(List<Show> shows)
        {
        ...
        public static int HighestYearIMDBRating(List<Show> shows)
        {
            return shows
